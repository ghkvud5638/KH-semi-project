...
public class AskPaging {
	...
	//총 게시글 수만 입력하는 생성자
	public AskPaging(int totalCount) {
	...
	public AskPaging(int totalCount, int curPage) {
		this.setTotalCount(totalCount);
	...
	public AskPaging(int totalCount, int curPage, int listCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
	...
	public AskPaging(int totalCount, int curPage, int listCount, int pageCount) {
		this.setTotalCount(totalCount);
		this.setCurPage(curPage);
		this.setListCount(listCount);
	...
	private void makePaging() {
		...
		if(listCount == 0)	setListCount(6);	//화면에 보여질 게시글 수 기본값 세팅
