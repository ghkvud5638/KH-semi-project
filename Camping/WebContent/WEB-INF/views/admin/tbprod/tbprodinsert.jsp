...
function mainPreview(target) {
	...
	$('.mainPreview').css('margin','-85px 0px 0px 617px');
	}
...
$('#insertBtn').on('click', function(){
	...
	<div id="wriTitle"><b>상품 등록</b></div>
	 <form action="/admin/prodinsert" method="post" enctype="multipart/form-data" id="insertform">
		<select name="cate_id" id="cate_id">
			<option value="selectnono">상품 종류를 선택하세요</option>
...
<!-- 				<button type="submit">작성</button> -->
				...
				<a href="/admin/prodlist"> <button type="button">취소</button>	</a>
		</div>	
