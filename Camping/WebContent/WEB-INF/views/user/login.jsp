...
<!--         <form method="post" id="loginForm" action="/user/loginProcess"> -->
...
<!--                 <input type="email" id="loginId" name="loginId" placeholder="ID" > -->
            ...
            <!-- 로그인 버튼 -->
            <button type="button" class="btn_login" onclick="loginFunc();">로그인</button>
            <div class="login_append">
  
                <span>
                <a href="/user/signup" class="link_signup">회원가입</a>
                </span>
                <span class="txt_find">
